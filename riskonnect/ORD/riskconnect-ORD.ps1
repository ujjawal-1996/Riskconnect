...
Set-RegValue -CoreTicket $CoreTicket -Key 'HKLM:\SYSTEM\CurrentControlSet\Services\W32Time\Parameters\' -Name 'NTPserver' -Type 'String' -Value '1127437-CHDC01.riskonnect.rk1,0x01 1127438-CHDC02.riskonnect.rk1,0x01' -OutputTicket $CoreTicket
