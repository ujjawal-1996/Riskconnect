...
Set-RegValue -CoreTicket $CoreTicket -Key 'HKLM:\SYSTEM\CurrentControlSet\Services\W32Time\Parameters\' -Name 'NTPserver' -Type 'String' -Value '1137618-FRDC01.riskonnect.rk1,0x01' -OutputTicket $CoreTicket
