...
Set-RegValue -CoreTicket $CoreTicket -Key 'HKLM:\SYSTEM\CurrentControlSet\Services\W32Time\Parameters\' -Name 'NTPserver' -Type 'String' -Value '1124778-DC01.STARBASE-EMEA.LOCAL,0x01 1124779-DC02.STARBASE-EMEA.LOCAL,0x01' -OutputTicket $CoreTicket
