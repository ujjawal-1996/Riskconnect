...
$text=ConvertTo-BBCode -Data $($WhamOutput | Select-Object *) | Out-String ;$text 
Add-CoreTicketUpdate -Text $text -TicketNumber  $Ticket 
Set-RegValue -Ticket $Ticket  -Key 'HKLM:\SYSTEM\CurrentControlSet\Services\W32Time\Parameters\' -Name 'NTPserver' -Type 'String' -Value  '1067617-DAVW731.stars-net.com,0x01 1067625-DAVW826.stars-net.com,0x01'
$text=ConvertTo-BBCode -Data $($WhamOutput | Select-Object *) | Out-String ;$text 
Add-CoreTicketUpdate -Text $text -TicketNumber  $Ticket 
